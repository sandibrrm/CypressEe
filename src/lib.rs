...
#[derive(Debug)]
pub struct CypressE2eProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CypressE2eProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CypressE2e processing");
    
    let mut processor = CypressE2eProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CypressE2eProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CypressE2eProcessor::new(false);
